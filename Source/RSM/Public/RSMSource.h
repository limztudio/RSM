...
#include "RSMSource.generated.h"

UCLASS()
class RSM_API ARSMSource : public ALight{
	GENERATED_UCLASS_BODY()

	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category="Light", meta=(ExposeFunctionCategories="RSMSource,Rendering|Lighting"))
	class URSMSourceComponent* RSMSourceComponent;
